                ...
                <PopoverContent className="w-80">
                  <Link to='/profile' className="flex gap-2 space-y-2">
                    <Avatar>
                      ...
                      <AvatarImage src={`${BASE_URL}/${user?.profile?.profilePhoto}`} alt="User Avatar" />
                      <AvatarFallback>{user?.fullname?.charAt(0).toUpperCase()}</AvatarFallback>
                      {/* <AvatarImage src ="https://github.com/shadcn.png" alt="@shadcn" /> */}
                    </Avatar>
...
//     <div
//       ref={stickyRef}
//       className={`sticky top-0 z-10 ${isSticky ? 'bg-background shadow' : 'bg-background'}`}
//     >
...
//                     <Link
//                       to="/profile"
//                       className="flex items-center gap-2 hover:text-[#F83002]"
//                     >
...
//       {/* Mobile Menu */}
//       {isMenuOpen && (
//         <div className="lg:hidden bg-white shadow p-4">
